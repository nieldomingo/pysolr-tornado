...
class SolrTestCase(AsyncTestCase):
    ...
    def setUp(self):
        ...
        # Short timeouts.
        self.solr = SolrTornado('http://localhost:8983/solr/core0', timeout=2)
        self.docs = [
            {
                'id': 'doc_1',
                'title': 'Example doc 1',
    ...
    def test__send_request(self):
        ...
        try:
            ...
            raise AssertionError, "did not raise SolrTornadoError"
    ...
    def test_delete(self):
        ...
        try:
            yield self.solr.delete(id='foo', q='bar')
        except ValueError:
            pass
        else:
            raise AssertionError, "should raise ValueError"
